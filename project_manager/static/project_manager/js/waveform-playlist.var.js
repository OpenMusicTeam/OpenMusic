	  ...
	  _createClass(_class, [{
	    ...
	    */
	    ...
	    value: function renderControls(data) {
	      ...
	      }, [(0, _h2.default)('header', [this.name]), (0, _h2.default)('div.btn-group', [(0, _h2.default)('span.btn.btn-outline-secondary.btn-xs.btn-mute' + muteClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('mute', _this2);
	        }
	      }, ['Mute']), (0, _h2.default)('span.btn.btn-outline-secondary.btn-xs.btn-solo' + soloClass, {
	        onclick: function onclick() {
